...
import infer_yolo_v7_instance_segmentation.yolov7.seg.segment.val as validate  # for end-of-epoch mAP
from infer_yolo_v7_instance_segmentation.yolov7.seg.models.experimental import attempt_load
from infer_yolo_v7_instance_segmentation.yolov7.seg.models.yolo import SegmentationModel
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.autoanchor import check_anchors
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.autobatch import check_train_batch_size
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.callbacks import Callbacks
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.downloads import attempt_download, is_url
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.general import (LOGGER, check_amp, check_dataset, check_file, check_git_status, check_img_size,
...
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.loggers import GenericLogger
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.plots import plot_evolve, plot_labels
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.dataloaders import create_dataloader
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.loss import ComputeLoss
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.metrics import KEYS, fitness
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.plots import plot_images_and_masks, plot_results_with_masks
from infer_yolo_v7_instance_segmentation.yolov7.seg.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, select_device, smart_DDP, smart_optimizer,
...
def train(hyp, opt, device, on_epoch_end, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in {-1, 0}:
            ...
            on_epoch_end(metrics_dict,  epoch)
            if plots:
